        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">Institution Profile Not Found</h2>
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <Card className="mb-8">
                    ...
                    <CardContent>
                        ...
                        {institutionData?.prospectus && (
                            <div className="mt-4">
                                <label className="text-sm font-medium text-slate-700">Prospectus</label>
                                <div className="mt-1 p-4 bg-slate-50 rounded-lg max-h-32 overflow-y-auto">
                                    <p className="text-slate-700 text-sm leading-relaxed">{institutionData.prospectus}</p>
                                </div>
                            </div>
                        )}
                    </CardContent>
